<template>
    ...
    <!-- <FormComponent title="Update note" btn="Update notes" :Name="Name" :Descriptions="Descriptions"/> -->
</template>
...
export default{
    ...
    async getOneNote(){
            ...
            console.log(id);
            await axios.get(`http://localhost:5000/api/${id}`)
            .then(response => {
    ...
    handlesubmit(e){
        ...
        axios.patch(`http://localhost:5000/api/update/${id}`,Data)
        .then(res =>{
